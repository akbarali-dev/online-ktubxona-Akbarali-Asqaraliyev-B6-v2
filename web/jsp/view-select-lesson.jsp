...
<div class="row mt-5 ml-0 mr-0" style="height: 400px;">
    <div class="col-md-6 offset-3 mb-5" style="background-color: white; border-radius:10px ;border: 2px solid gray;box-shadow: 5px 10px 8px #888888;z-index: 11;">
        <form  class="mt-5 mb-5">
            ...
            <div class="form-group">
                <label for="lessonPrice">Lesson video: </label>
            ...
            <div class="form-group">
                ...
                <textarea  name="description" type="text" class="form-control"
                           ...
                           here">${selectLesson.task}</textarea>
            </div>

            <div class="form-group">
                <label for="lessonDescription2">Lesson guide: </label>
                <textarea  name="description" type="text" class="form-control"
                           id="lessonDescription2" placeholder="Enter lesson task
                           here">${selectLesson.guide}</textarea>
            </div>
...
<%--                <h6 style="color: #00cc00;">The authors of the lesson</h6>--%>
<%--                <c:forEach var="author" items="${selectLesson.authors}">--%>
...
<%--            </div>--%>
            ...
            <a href="/lessons" class="btn btn-primary mt-3"> Back </a>
        </form>
    </div>
</div>
