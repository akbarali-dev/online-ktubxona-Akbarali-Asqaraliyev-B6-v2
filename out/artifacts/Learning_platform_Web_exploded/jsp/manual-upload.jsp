...
<form action="${pageContext.request.contextPath}/upload" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            <label for="videoUpload"><b>Select a file to upload:</b></label>
                <input type="file" name="file" id="videoUpload" accept="application/pdf">
        </div>
    <div class="form-group">
        ...
        <select class="custom-select custom-select-md mb-3" name="lessonId" id="selectLesson">
            <%--@elvariable id="lesson" type="java.util.List"--%>
    ...
    <div class="form-group">
        ...
        <a href="/upload/manualData" class="btn btn-primary ml-3" style="width: 60px;">    Back    </a>
        </div>
</form>
</div>
  </div>
