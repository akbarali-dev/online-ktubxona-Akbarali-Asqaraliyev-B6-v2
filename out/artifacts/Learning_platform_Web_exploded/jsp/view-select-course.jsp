        ...
        <form class="mt-5 mb-5">
            ...
            <div class="form-group">
                ...
                <textarea name="description" type="text" class="form-control"
                          ...
                          placeholder="Enter course description here">${selectCourse.description}</textarea>
            </div>
            ...
            <div class="form-group">
                <div class="container-md p-0">
                    ...
                    <c:forEach var="author" items="${selectCourse.authors}">
                        <h6><a href="/users/userAllData/${author.id}"
                               style="color: black">${author.firstName} ${author.lastName}</a></h6>
                    </c:forEach>
                </div>
            </div>
            <div class="form-group">
